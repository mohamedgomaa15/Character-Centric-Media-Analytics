...
class NetworkCharacterGenerator():

    def __init__(self):
       pass

    def generate_character(self, df):
        ...
        for row in df["ners"]:
            ...
            for sentence in row:
                ...
                previous_entities_flatten = sum(previous_entities_in_window, [])
    ...
    def network_graph(self,relationship_df):
        relationship_df = relationship_df.sort_values('value', ascending=False)
